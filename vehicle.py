class Vehicle(object):
    ...
    def __init__(self,year,mileage,purchase_price,serial_number):
        try:
            ...
            print("{} is not a year!".format(year))

        try:
            mileage = int(mileage)
        except ValueError:
            print("{} is not a mileage!".format(mileage))

        try:
            purchase_price = int(purchase_price)
        except ValueError:
            print("{} is not a purchase price!".format(purchase_price))
    ...
    def __str__(self):
        return str(Vehicle.generate_vehicle_id())
    ...
    def generate_vehicle_id():
        new_id = Vehicle.vehicle_id + 100000
