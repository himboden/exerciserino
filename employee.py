...
class Manager(Employee):
    ...
    def get_sales_report(self,salesman):
        ...
        try:
            for key in salesman.sales:
                grand_total += salesman.sales[key]
            print("{}'s current cummulative sales: \n{}".format(salesman.get_name(),grand_total))
        except KeyError:
            print("{} doesn't have any sales yet! Let's fire him!".format(salesman))
